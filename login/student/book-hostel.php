                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Parent Name</h4>
                                        <div class="form-group">
                                            <input type="text" name="gname" id="gname" class="form-control" placeholder="Enter Parent's Name" required>
                                        </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Relation</h4>
                                        <div class="form-group">
                                            <input type="text" name="grelation" id="grelation" required class="form-control" placeholder="Parent's Relation with Parent">
                                        </div>
                                </div>
                            </div>
                        </div>
