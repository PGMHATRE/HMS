                    ...
                    <div class="card border-right">
                        <div class="card-body">
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                <div>
                                    <div class="d-inline-flex align-items-center">
                                        <h3 class="text-dark mb-1 font-weight-medium">Download Parent's Confirmation Form</h3>
                                
                                    </div>
                                    <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">Download</h6>
                                </div>
                                <div class="ml-auto mt-md-3 mt-lg-0">
                                    <a href="../assets/leave_parents.pdf" download>
